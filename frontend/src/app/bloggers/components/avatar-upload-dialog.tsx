...
export type AvatarItem = { type: 'url'; url: string; fileId?: number } | { type: 'file'; file: File; previewUrl: string; hash?: string }
...
export default function AvatarUploadDialog({ currentAvatar, onClose, onSubmit }: AvatarUploadDialogProps) {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			if (previewFile) {
				setIsUploading(true)
				const uploaded = await uploadImage(previewFile.file, 'bloggers')
